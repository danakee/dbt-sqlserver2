...
pub fn list_relations(
    ...
    let sql = format!(
        "SELECT TABLE_NAME, TABLE_CATALOG AS TABLE_QUALIFIER, TABLE_SCHEMA AS TABLE_OWNER, TABLE_TYPE \
...
pub struct SqlServerMetadataAdapter {
    #[allow(dead_code, reason = "TODO implement SqlServerMetadataAdapter")]
...
impl MetadataAdapter for SqlServerMetadataAdapter {
    ...
    fn list_relations_schemas_inner(
        ...
        let map_f = move |conn: &'_ mut dyn Connection,
            ...
            let sql = format!(
                "SELECT COLUMN_NAME, DATA_TYPE AS TYPE_NAME, '' AS REMARKS, IS_NULLABLE \
